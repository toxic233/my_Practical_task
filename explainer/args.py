...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='Cora',
                    help='Name of the dataset. Default is Cora. Options: Cora, CiteSeer, PubMed, ACM, IMDB, DBLP, syn1, syn2, syn3, syn4')
        
    parser.add_argument('--model', type=str, default='graphsage',
                    help='Name of the node representation learning model. Default is graphsage. Options: graphsage, dgi, magnn')
